...
contract ERC721Facet {
    ...
    function internalTransferFrom(
        ...
        require(_to != address(0), "NFTFacet: Can't transfer to 0 address");
        require(_from != address(0), "NFTFacet: _from can't be 0 address");
        //require(_from == s.tokenIdOwner[_tokenId], "NFTFacet: _from is not owner, transfer failed");
        require(
            _sender == _from || _sender == s._tokenApprovals[_tokenId],
            "NFTFacet: Not owner or approved to transfer"
        );
